...
#+begin_src emacs-lisp
  ...
  (setq exec-path (append '("/home/leon/mambaforge/bin") exec-path))
#+end_src

#+RESULTS:
| /home/leon/mambaforge/bin | /usr/local/sbin/ | /usr/local/bin/ | /usr/sbin/ | /usr/bin/ | /sbin/ | /bin/ | /usr/games/ | /usr/local/games/ | /snap/bin/ | /snap/bin/ | /usr/lib/emacs/28.1/x86_64-linux-gnu/ |
